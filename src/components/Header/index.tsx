...
import { isLoading, setLoading } from "@/redux/features/loading-slice";
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        >
            ...
            <div className="max-w-[1200] w-full">
              <form>
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[480px] sm:min-w-[480px] w-full">
                    {" "}
                    {/* <!-- divider --> */}
          ...
          {/* <!-- header top right --> */}
          <div className="flex w-full lg:w-auto items-center gap-10">
            {/* <!-- divider --> */}
                ...
                <Link href="/signin" className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-custom-sm text-dark">
                      {currentUser ? currentUser.user_name : "Sign In"}
                    </p>
                  </div>
                </Link>
